                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ url('user/form') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea id="address" class="form-control address @error('address') is-invalid @enderror" name="address" required autocomplete="address"></textarea>
                        ...
                        <div class="form-group row">
                            <label for="country" class="col-md-4 col-form-label text-md-right">Template Name</label>

                            <div class="col-md-6">
                                <select name="template" id="template" class="form-control @error('template') is-invalid @enderror" required="">
